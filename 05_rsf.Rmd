...
library(ResourceSelection)
  ...
  starttime <- Sys.time()
  mod11_rspf_99boot <- rspf(use ~ building_2500 + log_road_dist + ar5_recoded + traffic_high + 
  ...
  starttime <- Sys.time()
  mod11a_rspf_99boot <- rspf(use ~ building_2500 + log_road_dist + ar5_recoded + road_type + 
