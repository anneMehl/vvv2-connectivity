...
library(ResourceSelection)
  ...
  mod11_rspf_99boot <- rspf(use ~ building_2500 + log_road_dist + ar5_rec_new + traffic_high + 
                            ...
                            data = datrsf8, m = datrsf8$id, B = 99, link = "logit")
  endtime <- Sys.time()     # second BEST (although see above)
  endtime-starttime
...
```{r}
  ...
  allmodelframe_rspf <- data.frame(rbind(mod11_99boot_rspfframe))
...
```{r}
library(effects)
plot(allEffects(mod11_rspf_99boot))
plot(effect("log_road_dist:traffic_high", mod11_rspf_99boot))
plot(Effect(c("log_road_dist", "traffic_high"), mod11_rspf_99boot))

plot_model(mod11_rspf_99boot, type = "est")
