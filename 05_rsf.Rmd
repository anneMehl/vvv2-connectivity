...
BIC(mod10_rspf_99boot, mod11_rspf_99boot, mod11a_rspf_99boot, mod11b_rspf_99boot)
...
plot_model(mod11c_rspf_99boot, type = c("est"), transform = NULL, show.values = TRUE, value.offset = 0.5, 
...
```{r}
  allmodelframe_rspf <- data.frame(rbind(mod11_99boot_rspfframe, mod11a_99boot_rspfframe))

  allmodelframe_rspf <- data.frame(rbind(mod11c_99boot_rspfframe))
