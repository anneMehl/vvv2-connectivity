...
for (i in c(1:100)){
tmp <- st_line_sample(roads, n = 1, density = 1/200, type = "random") %>% 
  st_as_sf()  
}


# random_points <- st_line_sample(roads, n = 2, density = 1/200, type = "random") %>% 
#   st_as_sf() # one per 200m
...
write_stars(random_points_r, "maps/random_points_rast.tif", update = T)
...
writeRaster(rast[[3]], file="maps/permeability_random_points_crop_1811.asc", overwrite = T)
