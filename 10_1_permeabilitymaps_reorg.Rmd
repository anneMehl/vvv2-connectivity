...
#### Make new raster map
```{r}
permeability_no_barrier <- prop_young_forest # just use any layer
values(permeability_no_barrier) <- predprob

plot(permeability_no_barrier)
...
permeability_current <- raster("maps/permeability_current.tif")
...
rast <- stack(quality6_0804, permeability_current, permeability_no_barrier)
...
writeRaster(rast[[3]], file="maps/permeability_no_humans_crop_0910.asc", overwrite = T)
