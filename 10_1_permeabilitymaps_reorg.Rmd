...
writeRaster(permeability_full_barrier, "maps/permeability_full_barrier.tif", overwrite = T)
...
writeRaster(rast[[3]], file="maps/permeability_no_barrier_crop_0810.asc", overwrite = F)
