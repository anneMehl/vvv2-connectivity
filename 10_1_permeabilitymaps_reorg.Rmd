...
cellStats(permeability_full_barrier_crop_0810, "sum")
...
quality_crop_1905 <- raster("maps/final_permability_and_quality/quality_crop_1905.asc")
cellStats(quality_crop_1905, "sum")
...
func_diff_full_barrier_1210 <- raster("maps/func_julia_outputs/func_diff_full_barrier_1210.asc")
cellStats(func_diff_full_barrier_1210, "sum")

func_diff_no_barrier_1210 <- raster("maps/func_julia_outputs/func_diff_no_barrier_1210.asc")
cellStats(func_diff_no_barrier_1210, "sum")

func_diff_no_humans_1210 <- raster("maps/func_julia_outputs/func_diff_no_humans_1210.asc")
cellStats(func_diff_no_humans_1210, "sum")

func_full_barrier_1210 <- raster("maps/func_julia_outputs/func_full_barrier_1210.asc")
cellStats(func_full_barrier_1210, "sum")

func_no_barrier_1210 <- raster("maps/func_julia_outputs/func_no_barrier_1210.asc")
cellStats(func_no_barrier_1210, "sum")

func_no_humans_1210 <- raster("maps/func_julia_outputs/func_no_humans_1210.asc")
