...
#### Make new raster map
```{r}
permeability_current <- prop_young_forest # just use any layer
values(permeability_current) <- predprob

plot(permeability_current)
str(permeability_current)
res(permeability_current)


writeRaster(permeability_current, "maps/permeability_current.tif", overwrite = F)
...
rast <- stack(quality6_0804, permeability8_with, permeability_current)
...
writeRaster(rast[[3]], file="maps/permeability_current_crop_0510.asc", overwrite = F)
