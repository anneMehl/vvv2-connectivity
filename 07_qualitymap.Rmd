...
quality5 <- young # just use any layer, raster("maps/prop_young_forest.tif")
values(quality5) <- predprob
plot(quality5)

writeRaster(quality5, "maps/quality5.tif", overwrite = T)
...
crop_quality5_stationary <- crop(quality5, p93_stationary)

# crop_quality4_migratory <- crop(quality4, e)

plot(crop_quality5_stationary)
res(crop_quality5_stationary)
...
writeRaster(crop_quality5_stationary, "maps/crop_quality5_stationary.asc", overwrite = T)
