...
p_crop_migratory3 <- crop(permeability, e)
plot(p_crop_migratory3)

qu_crop_migratory3 <- crop(quality, e)
plot(qu_crop_migratory3)


writeRaster(p_crop_migratory3, "maps/p_crop_migratory3.tif", overwrite = T)
writeRaster(qu_crop_migratory3, "maps/qu_crop_migratory3.tif", overwrite = T)
...
p187_migratory3 <- aggregate(p_crop_migratory3, fact = 8)

q460 <- aggregate(quality, fact = 20) 
q580 <- aggregate(quality, fact = 25) 
q187_migratory3 <- aggregate(qu_crop_migratory3, fact = 8)
...
writeRaster(p187_migratory3, "maps/p187_migratory3.asc", overwrite = T)
writeRaster(q187_migratory3, "maps/q187_migratory3.asc", overwrite = T)
