...
writeRaster(permeability2, "maps/permeability2.tif", overwrite = T)
...
crop_permeability2_migratory <- crop(permeability2, qu_crop_migratory4)

p_crop_permeability2 <- crop(permeability2, e)

plot(crop_permeability2_migratory)
str(crop_permeability2_migratory)
...
## write raster
```{r}
writeRaster(crop_permeability2_migratory, "maps/crop_permeability2_migratory.asc", overwrite = T)
```
