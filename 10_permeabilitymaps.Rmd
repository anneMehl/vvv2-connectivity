...
writeRaster(permeability5, "maps/27-02-2020_p_stationary_with_cross.tif", overwrite = T)
...
p_stationary_with_cross_2702 <- crop(permeability5, crop_quality5_stationary)

# p_crop_permeability2 <- crop(permeability2, e)

plot(p_stationary_with_cross_2702)
str(p_stationary_without_cross_2702)
res(p_stationary_without_cross_2702)

e <- crop_permeability4_stationary_with_cross
...
## write raster
```{r}
writeRaster(p_stationary_without_cross_2702, "maps/p_stationary_without_cross_2702.asc", overwrite = T)
```
