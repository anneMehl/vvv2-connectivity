...
rast <- stack(quality6_without_humans_0806, permeability8_with, permeability8_without_humans)
...
writeRaster(rast[[1]], file="maps/quality6_without_humans_0806.asc", overwrite = T)
writeRaster(rast[[2]], file="maps/permeability_with_crop_1905.asc", overwrite = F)
writeRaster(rast[[3]], file="maps/permeability_without_humans_crop_0506.asc", overwrite = T)
