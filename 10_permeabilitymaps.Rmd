...
#### Make new raster map
```{r}
permeability8_without_humans <- prop_young_forest # just use any layer
values(permeability8_without_humans) <- predprob

plot(permeability8_without_humans)
str(permeability8_without_humans)
res(permeability8_without_humans)


writeRaster(permeability8_without_humans, "maps/permeability8_without_humans.tif", overwrite = T)
...
rast <- stack(quality6_without_humans_2_0806, permeability8_with, permeability8_without_humans)
...
writeRaster(rast[[1]], file="maps/quality6_without_humans_2_crop_0806.asc", overwrite = F)
writeRaster(rast[[2]], file="maps/permeability_with_crop_1905.asc", overwrite = F)
writeRaster(rast[[3]], file="maps/permeability_without_roads_crop_0806.asc", overwrite = F)
