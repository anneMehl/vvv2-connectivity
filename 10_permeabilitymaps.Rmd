...
#### Make new raster map
```{r}
permeability8_without_roads_and_crossings <- prop_young_forest # just use any layer
values(permeability8_without_roads_and_crossings) <- predprob

plot(permeability8_without_roads_and_crossings)
str(permeability8_without_roads_and_crossings)
res(permeability8_without_roads_and_crossings)


writeRaster(permeability8_without_roads_and_crossings, "maps/permeability8_without_roads_and_crossings.tif", overwrite = T)
...
rast <- stack(quality6_without_roads_0806, permeability8_with, permeability8_without_roads_and_crossings)
...
writeRaster(rast[[3]], file="maps/permeability_without_roads and crossings_crop_2306.asc", overwrite = F)
